<template>
  ...
  <div class="page-container">
    <!-- 注册面板 -->
    <div class="auth-panel register-panel" v-show="showRegister">
      <div class="left-panel">
        <h2>注册完成？</h2>
        <p @click="switchToLogin" class="switch-link">立即登录</p>
      </div>
      <div class="right-panel">
        ...
        <form @submit.prevent="handleRegister" class="form">
          ...
          <div class="input-group">
            ...
            <input type="text" v-model="registerForm.verificationCode" placeholder="请输入验证码" required>
          </div>
          
          <div class="input-group">
            <i class="fa fa-lock input-icon"></i>
            <label class="input-label">密码：</label>
            <input type="password" v-model="registerForm.password" placeholder="请输入密码" autocomplete="new-password" required>
          </div>
          
          <div class="input-group">
            <i class="fa fa-lock input-icon"></i>
            <label class="input-label">确认密码：</label>
            <input type="password" v-model="registerForm.confirmPassword" placeholder="请再次输入密码" autocomplete="new-password" required>
          </div>
